          ...
          <section>
            ...
            {sortedProducts.length === 0 ? (
              ...
              >
                {sortedProducts.map(
                  (p) => {
                    // Calcular precios de todas las variantes
                    ...
                    if (p.price) {
                      // Producto con precio fijo (sin variantes)
                      ...
                      if (minPrice === maxPrice) {
                        // Todas las variantes tienen el mismo precio
                        formattedPrice = new Intl.NumberFormat("es-PE", {
                          style: "currency",
                          currency: "PEN",
                        }).format(minPrice);
                      } else {
                        // Precios diferentes - mostrar "Desde"
                        formattedPrice = `Desde ${new Intl.NumberFormat("es-PE", {
                          style: "currency",
                          currency: "PEN",
                        }).format(minPrice)}`;
                      }
