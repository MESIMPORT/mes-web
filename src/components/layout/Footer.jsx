export default function Footer() {
  return (
    <footer className="relative mt-4 border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 transition-colors">
      ...
      {/* ================= COPYRIGHT ================= */}
      <div className="border-t border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 transition-colors">
        <div className="max-w-7xl mx-auto px-6 py-4 text-[11px] text-slate-500 dark:text-slate-400 flex justify-between items-center">
          <span>
