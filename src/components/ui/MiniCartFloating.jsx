            ...
            {Array.isArray(item.accessories) && item.accessories.length > 0 && (
              <div className="mt-1 flex flex-wrap gap-1">
                {item.accessories.map((acc, i) => (
                  <span
                    key={i}
                    className="inline-flex items-center gap-1 px-1.5 py-px rounded-full bg-teal-50 border border-teal-200 text-[10px] font-medium text-teal-700 max-w-full truncate"
                    title={acc}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-2.5 h-2.5 shrink-0">
